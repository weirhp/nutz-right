...
jQuery.fn.pagination = function(maxentries, opts) {
  ...
  return this.each(function() {
    ...
    function drawLinks() {
      ...
      var np = numPages();
      // This helper function returns a handler function that calls pageSelected
      // with the right page_id
      ...
      var appendItem = function(page_id, appendopts) {
        ...
        if (page_id == current_page) {
          ...
          var lnk = jQuery("<a>" + (appendopts.text) + "</a>").bind("click", getClickHandler(page_id)).attr(
              'href', opts.link_to.replace(/__id__/, page_id));
